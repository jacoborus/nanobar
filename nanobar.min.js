var Nanobar=function(a){var c;c=this;a=a||{bg:"#000"};(function(a){var b=document.getElementById("nanobar-style");null===b&&(b=document.createElement("style"),b.setAttribute("type","text/css"),b.setAttribute("id","nanobar-style"),document.getElementsByTagName("head")[0].appendChild(b),b.styleSheet?b.styleSheet.cssText=a:b.appendChild(document.createTextNode(a)))})(".nanobarbar{width:0;height:100%;float:left;}.nanobarbar.active{transition: all 0.3s;}.goOut{margin-top:-4px;opacity:0}.nanobar{float:left;width:100%;height:4px;z-index:9999;}");
...
Nanobar.prototype.init=function(){this.bar.className="nanobarbar";this.bar.style.height="100%";this.bar.style.width=0;var a=this;setTimeout(function(){a.bar.className="nanobarbar active"},300)};Nanobar.prototype.finish=function(){var a=this;this.bar.style.height=0;setTimeout(function(){a.init()},300)};Nanobar.prototype.go=function(a){this.bar.style.width=a+"%"};